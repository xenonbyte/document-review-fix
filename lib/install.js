...
// satisfy the gate. Parse the complete document before inspecting the setting so syntax
// errors or duplicate keys anywhere in the metadata cannot be hidden after a valid value.
